...
import ContainerRelative from './components/ContainerRelative'
import MasInformacion from './masInformacion/MasInformacion'
import CurvedLoop from '@/lib/components/CurvedLoop'
import Contacto from './contacto/Contacto'

export default function PagePrincipalPublic() {
    return (
